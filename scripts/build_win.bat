nuitka --standalone --mingw64 --show-memory --show-progress ^
    ...
    --follow-import-to=modules,utils,ui --include-plugin-directory=modules,ui,utils ^
    --windows-product-version=1.3.35 --windows-company-name=DUMMY_WINDOWS_COMPANY_NAME --windows-product-name=BallonsOCR ^
    --output-dir=release  BallonsOCR
